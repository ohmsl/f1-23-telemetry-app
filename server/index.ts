...
import { PacketCarSetupData } from "@/types/CarSetupData";
...
import { PacketLobbyInfoData } from "@/types/LobbyInfoData";
import { Options } from "@/types/PacketEventData";
import { PacketMotionExData } from "@/types/PacketMotionExData";
...
import { PacketTyreSetsData } from "@/types/TyreSetData";
      ...
      this.socket.on("message", (msg: Buffer, rinfo: RemoteInfo): void => {
        ...
        switch (rinfo.size) {
          case PACKET_SIZES.motion: {
            ...
            const CarMotionDataParser = new Parser()
              .endianess("little")
            ...
            const PacketMotionDataParser = new Parser()
              .endianess("little")
              .nest("m_header", { type: PacketHeaderParser })
          ...
          case PACKET_SIZES.session: {
            ...
            const MarshalZoneParser = new Parser()
              .endianess("little")
              .floatle("m_zoneStart")
              .int8("m_zoneFlag");

            const WeatherForecastSampleParser = new Parser()
              .endianess("little")
              .uint8("m_sessionType")
              .uint8("m_timeOffset")
              .uint8("m_weather")
          ...
          case PACKET_SIZES.lapData: {
            ...
            const LapDataParser = new Parser()
              .endianess("little")
            ...
            const PacketLapDataParser = new Parser()
              .endianess("little")
              .nest("m_header", { type: PacketHeaderParser })
              .array("m_lapData", {
                type: LapDataParser,
          ...
          case PACKET_SIZES.event: {
            ...
            const FastestLapDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx")
              .floatle("lapTime");

            const RetirementDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx");

            const TeamMateInPitsDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx");

            const RaceWinnerDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx");

            const PenaltyDataParser = new Parser()
              .endianess("little")
              .uint8("penaltyType")
            ...
            const SpeedTrapDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx")
              .floatle("speed")
            ...
            const StartLightsDataParser = new Parser()
              .endianess("little")
              .uint8("numLights");

            const DriveThroughPenaltyServedDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx");

            const StopGoPenaltyServedDataParser = new Parser()
              .endianess("little")
              .uint8("vehicleIdx");

            const FlashbackDataParser = new Parser()
              .endianess("little")
              .uint32le("flashbackFrameIdentifier")
              .floatle("flashbackSessionTime");

            const ButtonsDataParser = new Parser()
              .endianess("little")
              .uint32le("buttonStatus");

            const OvertakeDataParser = new Parser()
              .endianess("little")
            ...
            if (EventStringCode === "FTLP") {
              ...
              data = new Parser()
                ...
                .string("m_eventStringCode", { length: 4 })
                .nest("m_eventDetails", {
                  type: DriveThroughPenaltyServedDataParser,
                })
                .parse(msg);
          ...
          case PACKET_SIZES.participants:
            {
              ...
              */
              ...
              const ParticipantDataParser = new Parser()
                .endianess("little")
              ...
              const PacketParticipantsDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
              ...
              const data: PacketParticipantsData =
                PacketParticipantsDataParser.parse(msg);
          ...
          case PACKET_SIZES.carSetups:
            {
              ...
              */
              ...
              const CarSetupDataParser = new Parser()
                .endianess("little")
                .uint8("m_frontWing")
                .uint8("m_rearWing")
                .uint8("m_onThrottle")
              ...
              const PacketCarSetupDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
                .array("m_carSetups", {
              ...
              const data: PacketCarSetupData =
                PacketCarSetupDataParser.parse(msg);
          ...
          case PACKET_SIZES.carTelemetry:
            {
              ...
              */
              ...
              const CarTelemetryDataParser = new Parser()
                .endianess("little")
                .uint16le("m_speed")
                .floatle("m_throttle")
                .floatle("m_steer")
              ...
              const PacketCarTelemetryDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
              ...
              const data: PacketCarTelemetryData =
                PacketCarTelemetryDataParser.parse(msg);
          ...
          case PACKET_SIZES.carStatus:
            {
              ...
              */
              ...
              const CarStatusDataParser = new Parser()
                .endianess("little")
              ...
              const PacketCarStatusDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
              ...
              const data: PacketCarStatusData =
                PacketCarStatusDataParser.parse(msg);
          ...
          case PACKET_SIZES.finalClassification:
            {
              ...
              */
              ...
              const FinalClassificationDataParser = new Parser()
                .endianess("little")
                .uint8("m_position")
                .uint8("m_numLaps")
                .uint8("m_gridPosition")
              ...
              const PacketFinalClassificationDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
                .uint8("m_numCars")
              ...
              const data: PacketFinalClassificationData =
                PacketFinalClassificationDataParser.parse(msg);
          ...
          case PACKET_SIZES.lobbyInfo:
            {
              ...
              */
              ...
              const LobbyInfoDataParser = new Parser()
                .endianess("little")
                .uint8("m_aiControlled")
                .uint8("m_teamId")
                .uint8("m_nationality")
              ...
              const PacketLobbyInfoDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
                .uint8("m_numPlayers")
              ...
              const data: PacketLobbyInfoData =
                PacketLobbyInfoDataParser.parse(msg);
          ...
          case PACKET_SIZES.carDamage:
            {
              ...
              */
              ...
              const CarDamageDataParser = new Parser()
                .endianess("little")
                .array("m_tyres_wear", {
                  type: "floatle",
                  length: 4,
              ...
              const PacketCarDamageDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
              ...
              const data: PacketCarDamageData =
                PacketCarDamageDataParser.parse(msg);
          ...
          case PACKET_SIZES.sessionHistory:
            {
              ...
              */
              ...
              const LapHistoryDataParser = new Parser()
                .endianess("little")
              ...
              const TyreStintHistoryDataParser = new Parser()
                .endianess("little")
                .uint8("m_endLap")
                .uint8("m_tyreActualCompound")
                .uint8("m_tyreVisualCompound");

              const PacketSessionHistoryDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
                .uint8("m_carIdx")
                .uint8("m_numLaps")
              ...
              const data: PacketSessionHistoryData =
                PacketSessionHistoryDataParser.parse(msg);
          ...
          case PACKET_SIZES.tyreSets:
            {
              ...
              */
              ...
              const TyreSetDataParser = new Parser()
                .endianess("little")
              ...
              const PacketTyreSetsDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
                .uint8("m_carIdx")
                .array("m_tyreSetData", {
              ...
              const data: PacketTyreSetsData =
                PacketTyreSetsDataParser.parse(msg);
          ...
          case PACKET_SIZES.motionEx:
            {
              ...
              */
              ...
              const PacketMotionExDataParser = new Parser()
                .endianess("little")
                .nest("m_header", { type: PacketHeaderParser })
              ...
              const data: PacketMotionExData =
                PacketMotionExDataParser.parse(msg);
